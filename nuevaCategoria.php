...
<body>
    ...
    <section>
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-md-4">
                    <img src="img/9.png" class="img img-fluid" style="height: 150px;"><br><br> 
                </div>
                <div class="col-md-4">
                <h4 class="text-center">Registro de categorias</h4><br>
						<form method="post" action="crearcategoria.php">
							<div class="form-group text-start">
                                <label for="nombre" class="text-start">Nombre:</label><br><br>
								<input type="text" 
									name="nombre" 									
                ...
                <div class="col-md-4">
                    <img src="img/16.png" class="img img-fluid" style="height: 150px;"><br><br> 
                </div>
            </div>
        </div>            
    </section>
