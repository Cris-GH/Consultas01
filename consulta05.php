            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <table class="table">
                            <?php
                                //Lista por producto
                                $sql = "SELECT sum(precio) from producto";
                                $res = $mbd -> query($sql);
                                $count = $res -> fetchColumn();
                                print "La suma de los precios de los productos son: S/." . $count;
                            ?>
                    </table>     
                    <img src="img/13.png" class="img img-fluid" style="height: 170px;"><br><br>            
                </div>
                <div class="col-md-3">
