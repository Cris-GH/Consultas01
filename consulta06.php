            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <table class="table">
                            <?php
                                //Lista por producto
                                $sql = "SELECT avg(precio) from producto";
                                $res = $mbd -> query($sql);
                                $count = $res -> fetchColumn();
                                print "El promedio de los precios de los productos son: S/." . round($count,2,PHP_ROUND_HALF_EVEN);
                            ?>
                    </table>
                    <img src="img/12.png" class="img img-fluid" style="height: 170px;"><br><br>                 
                </div>
                <div class="col-md-3">
